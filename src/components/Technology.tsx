    ...
    <>
      ...
      <section className="bg-[linear-gradient(180deg,#f7fbff_0%,#ffffff_48%,#faf7f9_100%)] px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <div className="relative flex flex-col items-center gap-6 text-center md:min-h-[15rem] md:gap-0">
              <div className="flex w-full max-w-[18rem] flex-col items-center gap-4 md:absolute md:left-[30%] md:top-1/2 md:max-w-[22rem] md:-translate-x-1/2 md:-translate-y-1/2 md:items-start">
                <div className="flex items-center justify-center gap-3 md:justify-start">
                  <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#74a3c6]/35 bg-[#20486b] shadow-inner shadow-[#0b1728] sm:h-28 sm:w-28">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#8ed5ff]/20 via-transparent to-transparent" />
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-[#8ec7e8]/15 bg-[#10293f] sm:h-[4.5rem] sm:w-[4.5rem]">
                      <svg viewBox="0 0 96 96" className="h-10 w-10 sm:h-12 sm:w-12" aria-hidden="true">
                ...
                <p className="max-w-none text-base leading-7 text-slate-100 sm:text-[1.08rem] sm:leading-[1.65] md:text-left md:text-[1.18rem] md:leading-[1.55] md:whitespace-nowrap">
                  {isKorean ? (
              ...
              <div className="flex items-center justify-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
                <svg
                  viewBox="0 0 40 120"
                  className="h-20 w-8 md:hidden"
                  aria-hidden="true"
                >
                  <defs>
                    <linearGradient id="connector-arrow-gradient-mobile" x1="50%" y1="0%" x2="50%" y2="100%">
                      <stop offset="0%" stopColor="#f0afb8" stopOpacity="0.25" />
                      <stop offset="55%" stopColor="#e88a97" />
                      <stop offset="100%" stopColor="#f7cdd3" />
                    </linearGradient>
                  </defs>
                  <path d="M20 10v60" fill="none" stroke="url(#connector-arrow-gradient-mobile)" strokeWidth="4.5" strokeLinecap="round" />
                  <path d="M10 58l10 20 10-20" fill="none" stroke="#e88a97" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M10 78l10 20 10-20" fill="none" stroke="#f0a9b4" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" opacity="0.95" />
                </svg>
              ...
              <div className="flex w-full max-w-[18rem] flex-col items-center gap-4 md:absolute md:left-[70%] md:top-1/2 md:max-w-[22rem] md:-translate-x-1/2 md:-translate-y-1/2 md:items-end">
                <div className="flex items-center justify-center gap-3 md:justify-end">
                  <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#d98a95]/35 bg-[#64384b] shadow-inner shadow-[#261924] sm:h-28 sm:w-28">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#f4b7c0]/20 via-transparent to-[#f0d3d8]/10" />
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-[#f0c3cb]/15 bg-[#3a2030] sm:h-[4.5rem] sm:w-[4.5rem]">
                      <svg viewBox="0 0 96 96" className="h-10 w-10 sm:h-12 sm:w-12" aria-hidden="true">
                ...
                <p className="max-w-xs text-base leading-7 text-slate-100 sm:text-[1.08rem] sm:leading-[1.65] md:text-right md:text-[1.18rem] md:leading-[1.55]">
                  {isKorean
                    ? "뇌 신경세포 회복과 정신 건강 회복"
